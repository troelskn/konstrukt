...
This setup is a minimal configuration, having only Konstrukt as a runtime dependency. If you need a more complete environment, you should take a look at `starterpack_default` instead.
